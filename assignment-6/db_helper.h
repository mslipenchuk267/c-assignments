...
extern int create_db(char *filename);  /* Creates table for each #-seperated file file */
int create_tables(char *filename);  /* Creates table for each #-seperated file file */
int populate_table_from_file(char *filename, char *sql_command);  /* Read data from extentionless files into tables */
